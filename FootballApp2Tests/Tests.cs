using Xunit;
using FootballApp2.Controllers.api;
using FootballApp2.Models;
//using FootballApp2.Pages;
...
namespace FootballApp2Tests.Tests
{
    public class CountriesControllerTests
    {
        ...
        {
            var _context = new Mock<DbfootballContext>();
        ...
        public async void TestAddCountrySameName()
        {
            ...
            _context.Setup<DbSet<Country>>(x => x.Countries).ReturnsDbSet(GetCountriesList());
            CountriesController controller = new CountriesController(_context.Object);
            Country countrypost = new Country { Id = 3, Name = "Argentina", Rating = 12, Teams=new List<Team>() };
            var response = (await controller.PostCountry(countrypost)).Result;
