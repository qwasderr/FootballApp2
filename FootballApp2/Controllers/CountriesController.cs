    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Countries != null ? 
                          ...
                          Problem("Entity set 'DbfootballContext.Countries'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Rating")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Rating")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
